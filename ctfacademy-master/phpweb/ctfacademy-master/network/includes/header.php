...
<div class="list-group-flush myLightBox mb-4">
  ...
  <a href="index.php#Protocols" class="list-group-item list-group-item-action lvl2">1.2 Giao thức</a>

  <a href="index.php#Wireshark" class="list-group-item list-group-item-action">2. Phân tích lưu lượng mạng và Wireshark</a>
