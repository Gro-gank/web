...
<!-- Main content -->
		<div class="col-md-9 order-1 order-md-2" >
				...
				<ol class="breadcrumb">
				  ...
				  <li class="breadcrumb-item active">Cybersecurity Ethics</li>
				</ol>				
...
<ul>
<li>  
			<a href="https://securityintelligence.com/tough-challenges-cybersecurity-ethics/" target="_blank">
		  Tough Challenges in Cybersecurity Ethics
		  </a>
		  </li>
		  
		  <li>
          <a href="https://www.securityroundtable.org/new-ethics-of-cybersecurity/" target="_blank">
            Man vs. Machine: The New Ethics of Cybersecurity
          </a>
		  </li>
		  
		<li>
          <a href="https://www.issa.org/page/CodeofEthics" target="_blank">
            ISSA Code of Ethics
          </a>
		  </li>
		  
		  <li>
          <a href="https://www.sans.org/security-resources/ethics" target="_blank">
            IT Code of Ethics
          </a>
		  </li>
</ul>
...
<p class="text-center h5"><b>Resources</b></p>
