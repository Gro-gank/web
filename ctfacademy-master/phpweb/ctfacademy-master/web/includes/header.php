...
<html  lang="en">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
			<title>ACT CTF Academy : Khai thác ứng dụng WEb	</title>
			...
			<link href="../src/bootstrap/css/bootstrap.min.css" rel="stylesheet">	
				...
				<div class="row">				
					<div class="col-md-12">
						...
						<div class="floatText">						
						<h2 class="display-4">						
						<span class="mainblue" style="font-size: 3rem;">					
						<a href="../index.php">						
						ACT CTF Academy
						</a>						
						</span>						
...
<div class="list-group-flush myLightBox mb-4">
  ...
  <a href="index.php#database" class="list-group-item list-group-item-action lvl2">1.4 Cơ sở dữ liệu</a>
  ...
  <a href="index.php#Summary" class="list-group-item list-group-item-action">3. Tóm tắt</a>
